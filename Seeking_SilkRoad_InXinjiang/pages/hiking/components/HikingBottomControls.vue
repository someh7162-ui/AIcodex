  ...
  <view class="bottom-controls">
    ...
    <view class="secondary-actions">
      <view class="secondary-actions-row">
        ...
        <view class="secondary-btn offline-kit-btn" @tap="emit('open-offline-kit')">
          {{ offlineKitActionText }}
        </view>
      </view>
    </view>
  </view>
...
const emit = defineEmits(['toggle-track', 'toggle-guard', 'sos-message', 'finish-track', 'clear-track', 'sos-visibility-change', 'offline-pack-action', 'open-safety-plan', 'open-offline-kit'])
